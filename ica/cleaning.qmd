...
```{r}
weather <- read_csv("~/portfolio-hmahamud16/ica/data/raw/weather.csv")
```

```{r}
# I think that RecordText is the one that doesn't make sense in this context..
